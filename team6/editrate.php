...
$query = "SELECT tenants.name, ratings.overall_rating FROM ratings INNER JOIN tenants ON ratings.tenant_id = tenants.tenant_id WHERE digs_id = $ID";
                    ...
                    <table style="width:60%">
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="rate" size="50" id="rate" value="<?php echo $Rate; ?>" required><br>
                              <br>
