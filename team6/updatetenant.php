...
$Contact_ = $_REQUEST['contact'];
$Status_ = $_REQUEST['status'];
$tenantID_ =$_REQUEST['tenantID'];
...
//connect
 $conn = mysqli_connect(SERVERNAME, USERNAME, PASSWORD, DATABASE)
  ...
  $query = "UPDATE tenants SET name = '$Name_', email = '$Email_',
  contact_number = '$Contact_', status = '$Status_'
 WHERE tenant_id = '$tenantID_'";
