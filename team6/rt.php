...
$query = "SELECT tenants.name, ratings.overall_rating FROM tenants INNER JOIN ratings ON tenants.tenant_id = ratings.tenant_id WHERE digs_id = $ID";
...
while ($row = mysqli_fetch_array($result)){
   ...
   echo "<td>" . "<a href=\"editrate.php?id=" . $row['digs_id'] . "\"><input type=\"button\" value=\"Edit\"></a>" . "</td>";
   echo "<td>" . "<a href=\"deleterate.php?id=" . $row['digs_id'] . "\"><input type=\"button\" value=\"Delete\" onClick=\"
