...
<h1 id="md">MANAGE DETAILS</h1>
         <nav>
            <ul id="adminmenu">
                ...
                <li>
                    <a href="ratings.php" class="active">Ratings</a>
                </li>
 ...
 while ($row = mysqli_fetch_array($result)) {
     echo "<tr>";
     echo "<td>"  . $row['criteria_1'] . "</td>";
     echo "<td>"  . $row['criteria_2'] . "</td>";
     echo "<td>"  . $row['criteria_3'] . "</td>";
     echo "<td>"  . $row['criteria_4'] . "</td>";
     echo "<td>"  . $row['criteria_5'] . "</td>";
     echo "</tr>";
 }
 echo "</table>";
         //close connection
